...
<!-- Device + firmware you actually ran this on. "Builds but untested on hardware" is fine to say, just say it. -->
...
<!-- Paste the relevant excerpt from KOBOeReader/.adds/nickel-home/nickel-home.log for the affected flow (the startup block plus the lines around your change). -->
